...
namespace Multipagos2V10.Escucha
{
    class LeeC25
    {
        ...
        public LeeC25(Puerto oPuerto, Tarjeta oTarjeta)
        {
        ...
        /**
        * Lee los datos de respuesta del comando 25.
        */
            ...
            try
            {
                ...
                if (datos != null)
                {
                    if (Arreglos.isValidLrc(datos))
                    {
                        ...
                        // Si la lectura del comando C30 es exitosa.
                    ...
                    {
                        System.Console.WriteLine("LRC_INVALIDO C25");
        ...
        /**
         * Espera por la respuesta del comando C25.
         */
        public void espera()
        {
            oTarjeta.setStatusLectura(-1);
